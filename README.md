...
:grin: I am also wrting weekly paper notes about latest LLM-enhanced RS at WeChat. Welcome to scan the [QR-Code](https://github.com/CHIANGEL/Awesome-LLM-for-RecSys/blob/main/wechat_for_paper_notes.jpeg).
